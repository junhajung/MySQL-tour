									...
									<form action="${pageContext.request.contextPath}/user/content_update"
										...
										<input type="hidden" value="stay" name="role"> <input
										 ...
										 <input type="hidden" value="" name="phone"> 
										  <input
											type="hidden" value="" name="menu">  <input
										...
										<div class="blog_details">
											...
											<h2>
												<input name="name" value="${staylist.name}"
													class="form-control">
											</h2>

											<p class="excert">
												<textarea style="height: 300px;" name="content"
													class="form-control">${staylist.content}</textarea>
											</p>
											...
											<div class="col-lg-12 offset-lg-0">
												<div class="media contact-info">
													<span class="contact-info__icon"><i
														...
														value="${staylist.addr}" name="addr" class="form-control">
												...
												<div class="media contact-info">
													...
													<select name="kate" id="kateid">
														<option value="${staylist.kate}">
															${staylist.kate}</option>
														<option value="관광호텔">관광호텔</option>
														<option value="콘도/리조트">콘도/리조트</option>
														<option value="굿스테이">굿스테이</option>
												...
												<div class="media contact-info">
													...
													<div class="media-body">
														<h3>
															객실정보 : <input value="${staylist.info}" name="info"
																class="form-control">
														</h3>
													</div>
												</div>
												<div class="media contact-info">
													...
													<div class="media-body">
														<h3>
															위도 : <input value="${staylist.lat}" name="lat"
																class="form-control">
														</h3>
													</div>
												</div>
												<div class="media contact-info">
													...
													<div class="media-body">
														<h3>
															경도 : <input value="${staylist.lng}" name="lng"
																class="form-control">
														</h3>
													</div>
												</div>
												<div class="media contact-info">
													<span class="contact-info__icon"><i
														...
														<option selected="${staylist.region}">
															${staylist.region}</option>
					...
					<script>
						$(function(){
							$('.update_insert').click(function(){
								$('.reply_update').show(); $('.reply_content').hide(); $('.update_button').show(); $('.update_insert').hide();
							});
							$('.reply_content').click(function(){
								$('.reply_update').hide(); $('.update_insert').show(); $('.update_button').hide();
							});
						});
					</script> 
